# RERTCRACKSEG YOLO 🚀, AGPL-3.0 license
"""
Benchmark a YOLO model formats for speed and accuracy

Usage:
    from RERTCRACKSEG.yolo.utils.benchmarks import ProfileModels, benchmark
...
from RERTCRACKSEG import YOLO
from RERTCRACKSEG.yolo.engine.exporter import export_formats
from RERTCRACKSEG.yolo.utils import LINUX, LOGGER, MACOS, ROOT, SETTINGS
from RERTCRACKSEG.yolo.utils.checks import check_requirements, check_yolo
from RERTCRACKSEG.yolo.utils.downloads import download
from RERTCRACKSEG.yolo.utils.files import file_size
from RERTCRACKSEG.yolo.utils.torch_utils import select_device
    ...
    for i, (name, format, suffix, cpu, gpu) in export_formats().iterrows():  # index, (name, format, suffix, CPU, GPU)
        ...
        try:
            ...
            if not (ROOT / 'assets/bus.jpg').exists():
                download(url='https://RERTCRACKSEG.com/images/bus.jpg', dir=ROOT / 'assets')
